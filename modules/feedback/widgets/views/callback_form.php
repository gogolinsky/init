 ...
 * @var \app\modules\feedback\forms\CallbackForm $feedback
 */
...
<?php $form = ActiveForm::begin([
    ...
    <div class="form__body">
        <p class="form__subtitle">Бесплатная консультация</p>
            ...
            <span class="form__field">
                <label class="checkbox">
                    ...
                    <span class="checkbox__label">
                        Даю согласие на обработку <a href="<?= $privacy->getHref() ?>" target="_blank" class="button is-callback"> персональных данных</a>
                    </span>
                </label>
            </span>
        </div>
